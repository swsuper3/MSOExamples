...
//MessagePost m = new MessagePost("MarkRutte", "nieuwe maatregelen", "Aankondiging");
...
posts.Add(new MessagePost("MarkRutte", "nieuwe maatregelen", "Aankondiging", formatter));
posts.Add(new PhotoPost("Amalia", "me.png", "Koninklijke Selfie", formatter));
